        ...
        <div class="row">
            ...
            <div class="col-lg">
                <div class="form bg-light text-dark rounded">
                    <form action="/students/{{$tutor->id}}" method="POST" class="mx-3 px-3 my-5 pt-2 pb-5" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                        <h2 class="text-center mt-5">Editar Estudiante</h2>
                        <br>
                        <div class="form-group">
                            <label for="name"><b>Nombre del Estudiante:</b></label>
